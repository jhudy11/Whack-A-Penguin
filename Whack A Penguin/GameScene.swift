        ...
        if let touch = touches.first {
            ...
            for node in tappedNodes {
                ...
                if node.name == "charFriend" {
                    ...
                    let whackSot = node.parent!.parent as! WhackSlot
                    
                    if !whackSot.isVisible { continue }
                    if whackSot.isHit { continue }
                    
                    whackSot.charNode.xScale = 0.85
                    whackSot.charNode.yScale = 0.85
